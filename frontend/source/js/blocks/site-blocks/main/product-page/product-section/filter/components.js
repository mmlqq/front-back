...
import { BLACK_COLOR, GRAY_COLOR, MEDIA_SIZES, OUTLINE_COLOR, TRANSITION_DURATION } from '../../../../../universal/styles-data/variables';
...
export const InputLabel = styled.label`
  ...
  &::before {
    ...
    border-radius: 30%;
    transform: translateY(-50%);
    transition: background-color, opacity, $transition-duration;
  }
`;
